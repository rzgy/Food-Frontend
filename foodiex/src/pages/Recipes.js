...
const Recipes = () => {
  ...
  return (
    <div className=" bg-[#252526] text-white font-serif flex flex-col items-center">
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-4">
        ...
        {categories.map((category) => (
          <div
            key={category._id}
            className="mb-6 border mt-3 border-orange-500 p-4 rounded"
          >
              ...
              {recipes
                ...
                .map((recipe) => (
                  <div>
                    <div
                      key={recipe._id}
                      className=" bg-white text-black p-4 rounded-lg shadow-md w-60 h-60 cursor-pointer"
